...
namespace Numerical.Benchmark
{
    internal class Root
    {
        ...
        public static readonly Problem[] problems1 =
        {
        ...
        public static readonly Problem[] problems2 =
        {
            new Problem //Lambert
            {
                Name = "f63",
        ...
        public static readonly Problem[] problems3 =
        {
            ...
            new Problem  // Near symmetric function
            {
                 Name = "f92",
                 F = (x) => x*x*x - 0.001,
                 a = -10,
        ...
        internal static void Run()
        {
            ...
            for (int i = 0; i < 3; ++i)
            {
                ...
                Console.WriteLine("Func;   bs;    fp;   ill;    ab;   ITP;   rid;    br;  modAB1;  modAB2");
