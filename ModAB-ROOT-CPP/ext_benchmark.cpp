// root_benchmark.cpp
// Benchmark of ROOT::Math::RootFinder algorithms + ModABRootFinder on 92 test problems.
...
// Wrapper for ROOT::Math::RootFinder (GSL-based bracket methods)
struct GSLSolver : SolverBase {
    ROOT::Math::RootFinder::EType type;

    GSLSolver(const char* n, ROOT::Math::RootFinder::EType t) { name = n; type = t; }
    ...
    SolverResult solve(const std::function<double(double)>& f,
        ...
        ROOT::Math::RootFinder finder(type);
...
int main() {
    ...
    solvers.emplace_back(new GSLSolver("Bisection", ROOT::Math::RootFinder::kGSL_BISECTION));
    solvers.emplace_back(new GSLSolver("Brent", ROOT::Math::RootFinder::kGSL_BRENT));
    solvers.emplace_back(new GSLSolver("FalsePos", ROOT::Math::RootFinder::kGSL_FALSE_POS));
    ...
    tee("  Solvers: Bisection, Brent (GSL), False Position (GSL), ModAB\n");
    tee("=====================================================================\n\n");
